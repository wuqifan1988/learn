...
public class DoubleConsumerTest {
    ...
    DoubleConsumer add1 = item -> System.out.println(item + 1.0);
    DoubleConsumer add2 = item -> System.out.println(item + 2.0);
...
//    void accept(double value);
     ...
     */
//    default DoubleConsumerTest andThen(DoubleConsumerTest after) {
